...
<link href="<?php echo $this->_var['ecsolve_path']; ?>/images/touch-icon.png" rel="apple-touch-icon-precomposed" />
<link href="<?php echo $this->_var['ecsolve_path']; ?>/images/favicon.ico" rel="shortcut icon" type="image/x-icon" />
<link href="<?php echo $this->_var['ecsolve_path']; ?>/ectouch.css" rel="stylesheet" type="text/css" />
</head>
