  ...
  <form action="flow.php" method="post" name="formCart" id="formCart">
    <ul class="radius10 cartitemlist">
        ...
        <div class="itemlist_l new-tbl-cell"> 
          ...
          <a target="_blank" href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>"> <img border="0" title="<?php echo $this->_var['goods']['goods_name']; ?>" src="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['goods']['goods_img']; ?>" class="lazy"> </a> 
